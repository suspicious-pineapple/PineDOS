...
echo "Linking.."
$HOME/opt/cross/bin/i686-elf-gcc -T ./linker.ld -o tmp/pinedos.bin -lgcc -ffreestanding -O2 -nostdlib tmp/boot.o tmp/kernel.o tmp/main.o tmp/string.o tmp/interrupts.o
